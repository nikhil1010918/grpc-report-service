...
const file_report_proto_rawDesc = "" +
	"\n" +
	"\freport.proto\x12\x05proto\"0\n" +
	"\x15GenerateReportRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\"5\n" +
	"\x16GenerateReportResponse\x12\x1b\n" +
	"\treport_id\x18\x01 \x01(\tR\breportId\"\x14\n" +
	"\x12HealthCheckRequest\"-\n" +
	"\x13HealthCheckResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status2\xa4\x01\n" +
	"\rReportService\x12M\n" +
	"\x0eGenerateReport\x12\x1c.proto.GenerateReportRequest\x1a\x1d.proto.GenerateReportResponse\x12D\n" +
	"\vHealthCheck\x12\x19.proto.HealthCheckRequest\x1a\x1a.proto.HealthCheckResponseB4Z2github.com/nikhil1010918/grpc-report-service/protob\x06proto3"
...
var file_report_proto_goTypes = []any{
	(*GenerateReportRequest)(nil),  // 0: proto.GenerateReportRequest
	(*GenerateReportResponse)(nil), // 1: proto.GenerateReportResponse
...
var file_report_proto_depIdxs = []int32{
	0, // 0: proto.ReportService.GenerateReport:input_type -> proto.GenerateReportRequest
	2, // 1: proto.ReportService.HealthCheck:input_type -> proto.HealthCheckRequest
	1, // 2: proto.ReportService.GenerateReport:output_type -> proto.GenerateReportResponse
	3, // 3: proto.ReportService.HealthCheck:output_type -> proto.HealthCheckResponse
